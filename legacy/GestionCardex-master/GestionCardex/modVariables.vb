Module modVariables
    Public vstrConnCardAvo As String = "server= CSJ-SQLMI01 ;uid= sa;pwd= a1de!;database= CardAvo; Pooling=true; Min Pool Size=0; Max Pool Size=100; Connection Lifetime=0"
    ...
    Public vstrStaticPc As String = "server= CSJ-SQLMI01 ;uid= sa;pwd= a1de!;database= StaticPc; Pooling=true; Min Pool Size=0; Max Pool Size=100; Connection Lifetime=0"
    ...
    Public vstrArt52 As String = "server= CSJ-SQLMI01 ;uid= sa;pwd= a1de!;database= Art52; Pooling=true; Min Pool Size=0; Max Pool Size=100; Connection Lifetime=0"
    ...
    Public vgServer As String = "CSJ-SQLMI01"
