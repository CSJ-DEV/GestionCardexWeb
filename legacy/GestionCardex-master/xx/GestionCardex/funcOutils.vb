    ...
    Public Sub funcRemplirCombo(ByVal cbo As ComboBox, ByVal optCombo As String)
        ...
        Select Case optCombo
            Case "Code"
                ...
                vstrConn = "server= CSJ-ART52 ;uid= sa;pwd= a1de!;database= CardAvo; Pooling=true; Min Pool Size=0; Max Pool Size=100; Connection Lifetime=0; Application Name= fillCombo"
            ...
            Case "Avocat"
                ...
                vstrConn = "server= CSJ-ART52 ;uid= sa;pwd= a1de!;database= CardAvo; Pooling=true; Min Pool Size=0; Max Pool Size=100; Connection Lifetime=0"
            ...
            Case "Ville"
                ...
                vstrConn = "server= CSJ-ART52 ;uid= sa;pwd= a1de!;database= StaticPC; Pooling=true; Min Pool Size=0; Max Pool Size=100; Connection Lifetime=0"
